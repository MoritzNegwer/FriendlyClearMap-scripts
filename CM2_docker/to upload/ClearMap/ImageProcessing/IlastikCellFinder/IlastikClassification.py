...
#import old stuff from CM1 Ilastik code path
import ClearMap.ImageProcessing.IlastikCellFinder.IlastikCellFinder as ilastik
#from ClearMap.ImageProcessing.BackgroundRemoval import removeBackground
from ClearMap.ImageProcessing.IlastikCellFinder.MaximaDetection import findCenterOfMaxima, findIntensity
from ClearMap.ImageProcessing.IlastikCellFinder.CellSizeDetection import detectCellShape, findCellSize, findCellIntensity
from ClearMap.ImageProcessing.IlastikCellFinder.StackProcessing import writeSubStack

from ClearMap.ImageProcessing.IlastikCellFinder.Timer import Timer
from ClearMap.ImageProcessing.IlastikCellFinder.ParameterTools import getParameter, writeParameter

from ClearMap.ImageProcessing.IlastikCellFinder.Plot import plotTiling
...
def classifyCells(img, classifyCellsParameter = None, classifier = None, classindex = 0, save = None, verbose = False,
    ...
    #debug
    print("image to be classified: ",len(img))
    print("classifier to be used: ",classifier)
