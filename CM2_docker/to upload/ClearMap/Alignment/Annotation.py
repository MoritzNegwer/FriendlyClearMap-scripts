...
default_extra_label = [
               ...
               #(14000,776,'posterior, corpus callosum','ccp'),#added by Moritz for Kim P7-21 atlas. Assuming (id,parent,name,short name)
               #(13210,882,'Pre and Post in Hippocampus, PrePost','RHP'),
               #(13180,322,'Primary somatosensory area, unassigned','SSp-un'),
               #(13190,13180,'Primary somatosensory area, unassigned, deep layer ','SSP-Un5'),
               ];
