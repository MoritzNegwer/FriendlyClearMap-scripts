...
if __name__ == "__main__":
  ...
  directory = '/media/wirrbel/Moritz_Negwer/VIP_docker/Lynn_VIP_P26_m69366_WT/' #must end on trailing slash   
  
  expression_raw      = '200525_VIP_P26_m69366_TdTom_13-28-31/13-28-31_VIP_P26_m69366_TdTom_UltraII_C00_xyz-Table Z<Z,4>.ome.tif'           
  expression_auto     = '200525_VIP_P26_m69366_autofluo_13-13-10/13-13-10_VIP_P26_m69366_autofluo_UltraII_C00_xyz-Table Z<Z,4>.ome.tif'
  ...
  '''
  atlas_dir = '/media/wirrbel/Moritz_Negwer/VIP_docker/Lynn_VIP_P26_m69366_WT/atlas_p21'
  ...
  io.delete_file(sink)
  io.convert(source, sink, processes=None, verbose=False, experimentalFixShape=True); #processes = None for all processors
  ...
  import pandas
  custom_label_csv = pandas.read_csv('/media/wirrbel/Moritz_Negwer/VIP_docker/Lynn_VIP_P26_m69366_WT/atlas_p21/regions_IDs.csv')
