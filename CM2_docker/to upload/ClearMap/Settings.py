...
elastix_path = '/usr/' #original #os.path.join(external_path, 'elastix/build');
...
imagej_path = '/home/wirrbel/Fiji.app/'; # '/usr/local/Fiji.app';
...
ilastik_path = '/home/wirrbel/ilastik-1.4.0b8-Linux/'; #'/usr/local/ilastik/ilastik-1.2.0-Linux';
