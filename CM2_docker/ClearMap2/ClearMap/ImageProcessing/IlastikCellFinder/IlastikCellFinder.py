...
import ClearMap.ImageProcessing.IlastikCellFinder.IO.FileList as filelist
...
def classifyPixel(project, source, sink = None, processingDirectory = None, cleanup = True):
  ...
  #debug 
  print("Ilastik cell finder, project: ", project )
  print("Ilastik cell finder, ilout: ", inpfile )
  print("Ilastik cell finder, ilinp: ", outfile)
