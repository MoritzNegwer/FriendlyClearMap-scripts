...
if __name__ == "__main__":
  ...
  #create temp files 
  ws.update(stitched = tempfile.NamedTemporaryFile(prefix = 'stitched', suffix ='.npy',delete=False).name)  
  ws.update(autofluo = tempfile.NamedTemporaryFile(prefix = 'autofluo', suffix ='.npy',delete=False).name)
