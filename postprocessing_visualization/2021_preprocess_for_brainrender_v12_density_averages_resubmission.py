...
target_folders = [
    "/media/wirrbel/MN_2/2022-01-16_brainrender_tech_paper_densities/PV_P14_Averages_techpaper_cam_03/", #must end on trailing slash
    ]
...
#this folder is required for group naming 
...
for target_folder in target_folders:
    ...
    for region in target_regions:
        render_screenshot (target_folder, cells_all, name_path, myterial.black, region, camera=techpaper_cam_03,add_points=False,hemisphere=False,add_density=True)
...
target_folders = [
    "/media/wirrbel/MN_2/2022-01-16_brainrender_tech_paper_densities/PV_P56_Averages_techpaper_cam_03/" #must end on trailing slash
    ]
...
for target_folder in target_folders:
    #once all added up, make 
    for region in target_regions:
        render_screenshot (target_folder, cells_all, name_path, myterial.red_dark, region, camera=techpaper_cam_03,add_points=False,hemisphere=False,add_density=True)
...
target_folders = [
    "/media/wirrbel/MN_2/2022-01-16_brainrender_tech_paper_densities/SST_Averages_techpaper_cam_03/", #must end on trailing slash
    ]
...
target_folders = [
    "/media/wirrbel/MN_2/2022-01-16_brainrender_tech_paper_densities/VIP_Averages_techpaper_cam_03/", #must end on trailing slash
    ]
