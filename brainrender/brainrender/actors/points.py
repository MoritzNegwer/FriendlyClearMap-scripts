...
class PointsDensity(Actor):
    def __init__(
        self, data, name=None, dims=(40, 40, 40), bounds=None, radius=None, colormap="Dark2", **kwargs
    ):
        """
        ...
        #note if you want to get at the locator info 
        volume = (
            vPoints(data)
            .density(dims=dims, bounds=bounds, radius=radius, **kwargs)
            .c(colormap)
            .alpha([0, 0.9])
            .mode(1) #max intensity projection
