...
def alignData(fixedImage, movingImage, affineParameterFile, bSplineParameterFile = None, resultDirectory = None, movingPoints = None, fixedPoints = None):
    ...
    if bSplineParameterFile is None:
        cmd = ElastixBinary + ' -m ' + movingImage + ' -f ' + fixedImage + ' -p ' + affineParameterFile + ' -out ' + resultDirectory;
    elif affineParameterFile is None:
        cmd = ElastixBinary + ' -m ' + movingImage + ' -f ' + fixedImage + ' -p ' + bSplineParameterFile + ' -out ' + resultDirectory;
    elif (movingPoints is None) or (fixedPoints is None):
        #omit -fp and -mp
        cmd = ElastixBinary + ' -m ' + movingImage + ' -f ' + fixedImage +  ' -p ' + affineParameterFile + ' -p ' + bSplineParameterFile + ' -out ' + resultDirectory; 
    else:
        cmd = ElastixBinary + ' -m ' + movingImage + ' -f ' + fixedImage +  ' -p ' + bSplineParameterFile + ' -out ' + resultDirectory + ' -mp ' + movingPoints + ' -fp ' + fixedPoints;
