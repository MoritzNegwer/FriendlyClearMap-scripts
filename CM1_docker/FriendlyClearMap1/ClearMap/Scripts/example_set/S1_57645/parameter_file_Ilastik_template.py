...
#Directory to save all the results, usually containing the data for one sample
BaseDirectory = '/home/wirrbel/2020-11-26_WFA_Ilastik/Cleamap_test/';
...
# TODO Maren: 
#cFosFile = os.path.join('/media/wirrbel/Moritz_Negwer/2020-11-01_WFA_Mo_S01/201101_2020-11-01_WFA_Mo_S01_WFA_14-19-13/14-19-13_2020-11-01_WFA_Mo_S01_WFA_UltraII_C00_xyz-Table Z\d{4}.ome.tif');
#AutofluoFile = os.path.join('/home/wirrbel/2020-11-26_WFA_Ilastik/probmap2_c0/WFA_m1-t00000-s00-0-cells_Probabilities_\d{4}.tif')

AutofluoFile = ('/media/wirrbel/Moritz_Negwer/2020-11-01_WFA_Mo_S01/201101_2020-11-01_WFA_Mo_S01_autofluo_Horizontal_focus_15-45-35/15-45-35_2020-11-01_WFA_Mo_S01_autofluo_Horizontal_focus_UltraII_C00_xyz-Table Z\d{4}.ome.tif')
cFosFile = ('/media/wirrbel/Moritz_Negwer/2020-11-01_WFA_Mo_S01/201101_2020-11-01_WFA_Mo_S01_WFA_14-19-13/14-19-13_2020-11-01_WFA_Mo_S01_WFA_UltraII_C00_xyz-Table Z\d{4}.ome.tif');
...
PathReg        = '/home/wirrbel/FriendlyClearmap/atlas/';
...
ilastikParameter = {
    ...
    "processingDirectory" : os.path.join(BaseDirectory, 'temp_ilastik'),  #where the temp file will be placed. If this is set to None, the file will be generated in /tmp, i.e. the RAM. If you have <256GB RAM, it will likely fill the memory and trigger the OOM-killer. 
