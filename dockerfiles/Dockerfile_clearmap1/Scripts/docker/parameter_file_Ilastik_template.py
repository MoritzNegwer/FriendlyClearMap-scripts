...
AtlasFile      = os.path.join(PathReg, 'atlas_p21/Kim_ref_P21_v2_brain.tif');
LabeledImage   = os.path.join(PathReg, 'atlas_p21/Kim_ref_P21_v2.1_label.nrrd'); 
AnnotationFile = os.path.join(PathReg, 'atlas_p21/regions_IDs.csv');
